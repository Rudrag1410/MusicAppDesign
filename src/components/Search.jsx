      ...
      <div className="right flex items-start flex-col justify-start flex-1 h-[100%] pt-[9rem]">
        ...
        <div className="detail flex flex-col mt-5 text-4xl">
          ...
          <span className="text-sm mt-3 text-[#4D586A]">
            🔍 Search Music with Ease! 🎶 Enter the Name or Direct URL of your
            favorite tunes and let the melody find you. Discover, play, and
            enjoy the perfect soundtrack for every moment. HarmonyHub - Where
            Music Meets Effortless Discovery.
          </span>
        </div>
        {/* Music Player */}
        <VisibilitySensor
